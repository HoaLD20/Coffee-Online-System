...
namespace Management {
    ...
    public partial class COFFEEDataSet2 : global::System.Data.DataSet {
        ...
        public partial class ProductDataTable : global::System.Data.TypedTableBase<ProductRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ProductRow AddProductRow(int IDCategory, string nameProduct, string available, double price, string description, byte[] photo, int status, string imageUrl) {
...
namespace Management.COFFEEDataSet2TableAdapters {
    ...
    public partial class ProductTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Product] WHERE (([IDProduct] = @Original_IDProduct) AND ((@IsNull_IDCategory = 1 AND [IDCategory] IS NULL) OR ([IDCategory] = @Original_IDCategory)) AND ((@IsNull_nameProduct = 1 AND [nameProduct] IS NULL) OR ([nameProduct] = @Original_nameProduct)) AND ((@IsNull_available = 1 AND [available] IS NULL) OR ([available] = @Original_available)) AND ((@IsNull_price = 1 AND [price] IS NULL) OR ([price] = @Original_price)) AND ((@IsNull_description = 1 AND [description] IS NULL) OR ([description] = @Original_description)) AND ((@IsNull_status = 1 AND [status] IS NULL) OR ([status] = @Original_status)) AND ((@IsNull_imageUrl = 1 AND [imageUrl] IS NULL) OR ([imageUrl] = @Original_imageUrl)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Product] ([IDCategory], [nameProduct], [available], [price], [description], [photo], [status], [imageUrl]) VALUES (@IDCategory, @nameProduct, @available, @price, @description, @photo, @status, @imageUrl);
SELECT IDProduct, IDCategory, nameProduct, available, price, description, photo, status, imageUrl FROM Product WHERE (IDProduct = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Product] SET [IDCategory] = @IDCategory, [nameProduct] = @nameProduct, [available] = @available, [price] = @price, [description] = @description, [photo] = @photo, [status] = @status, [imageUrl] = @imageUrl WHERE (([IDProduct] = @Original_IDProduct) AND ((@IsNull_IDCategory = 1 AND [IDCategory] IS NULL) OR ([IDCategory] = @Original_IDCategory)) AND ((@IsNull_nameProduct = 1 AND [nameProduct] IS NULL) OR ([nameProduct] = @Original_nameProduct)) AND ((@IsNull_available = 1 AND [available] IS NULL) OR ([available] = @Original_available)) AND ((@IsNull_price = 1 AND [price] IS NULL) OR ([price] = @Original_price)) AND ((@IsNull_description = 1 AND [description] IS NULL) OR ([description] = @Original_description)) AND ((@IsNull_status = 1 AND [status] IS NULL) OR ([status] = @Original_status)) AND ((@IsNull_imageUrl = 1 AND [imageUrl] IS NULL) OR ([imageUrl] = @Original_imageUrl)));
SELECT IDProduct, IDCategory, nameProduct, available, price, description, photo, status, imageUrl FROM Product WHERE (IDProduct = @IDProduct)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT IDProduct, IDCategory, nameProduct, available, price, description, photo, " +
                "status, imageUrl FROM dbo.Product";
        ...
        public virtual int Fill(COFFEEDataSet2.ProductDataTable dataTable) {
        ...
        public virtual COFFEEDataSet2.ProductDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            COFFEEDataSet2.ProductDataTable dataTable = new COFFEEDataSet2.ProductDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(COFFEEDataSet2.ProductDataTable dataTable) {
        ...
        public virtual int Delete(int Original_IDProduct, global::System.Nullable<int> Original_IDCategory, string Original_nameProduct, string Original_available, global::System.Nullable<double> Original_price, string Original_description, global::System.Nullable<int> Original_status, string Original_imageUrl) {
        ...
        public virtual int Insert(global::System.Nullable<int> IDCategory, string nameProduct, string available, global::System.Nullable<double> price, string description, byte[] photo, global::System.Nullable<int> status, string imageUrl) {
        ...
        public virtual int Update(
            ...
            if ((Original_imageUrl == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[22].Value = ((string)(Original_imageUrl));
            }
        ...
        public virtual int Update(
                    ...
                    global::System.Nullable<int> Original_status, 
                    string Original_imageUrl) {
            return this.Update(IDCategory, nameProduct, available, price, description, photo, status, imageUrl, Original_IDProduct, Original_IDCategory, Original_nameProduct, Original_available, Original_price, Original_description, Original_status, Original_imageUrl, Original_IDProduct);
        }
    }
